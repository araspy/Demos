...
console.log("DATA:", data)
      ...
      for (let i in data){
        ...
        series[0].data.push(element.Rem_Blue);
        series[1].data.push(element.Rem_Lemon);
        series[2].data.push(element.Rem_Punch);
        count+=1;
        entries.push(count);
     ...
     console.log("entries", entries);
      setSeries( series);
      setEntries(entries);
      chart = new ApexCharts(document.querySelector('#chart'), optionsTemp);
      chart.render();
...
export default LineChartRemain;